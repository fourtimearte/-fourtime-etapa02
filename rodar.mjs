...
const SUITES = [
  ...
  'teste_v298_ajustes', 'teste_compat_v298', 'teste_impressao_escura', 'teste_painel_v298',
  'teste_arquivar_data', 'teste_cnpj', 'teste_brilho_obs', 'teste_cores_grupos',
  'teste_freio_servidor', 'teste_v298_correcoes', 'teste_cabecalho_v298',
  'teste_impressao_cores', 'teste_painel_abas', 'teste_marca_padrao',
...
const SUBIDA = [
  'teste_v298_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_v298_correcoes',    /* CEP após o blur, painel x fonte, visualizador   */
  'teste_cabecalho_v298',    /* as 12 células do cabeçalho, uma a uma           */
  ...
  'teste_compat_v298',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v298',       /* nenhum token do painel pode ter morrido      */
