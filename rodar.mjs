...
const SUITES = [
  ...
  'teste_v284_ajustes', 'teste_compat_v284', 'teste_impressao_escura', 'teste_painel_v284',
  'teste_arquivar_data',
...
const SUBIDA = [
  'teste_v284_ajustes',      /* o que a versão trouxe                        */
  'teste_arquivar_data',     /* a data de arquivamento: modal, máscara, pasta */
  'teste_compat_v284',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v284',       /* nenhum token do painel pode ter morrido      */
