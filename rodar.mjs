...
const SUITES = [
  ...
  'teste_v290_ajustes', 'teste_compat_v290', 'teste_impressao_escura', 'teste_painel_v290',
...
const SUBIDA = [
  'teste_v290_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_compat_v290',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v290',       /* nenhum token do painel pode ter morrido      */
