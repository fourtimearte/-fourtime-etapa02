...
const SUITES = [
  ...
  'teste_v291_ajustes', 'teste_compat_v291', 'teste_impressao_escura', 'teste_painel_v291',
  'teste_arquivar_data', 'teste_cnpj', 'teste_brilho_obs', 'teste_cores_grupos',
  'teste_freio_servidor',
...
const SUBIDA = [
  'teste_v291_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_compat_v291',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v291',       /* nenhum token do painel pode ter morrido      */
