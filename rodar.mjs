...
const SUITES = [
  ...
  'teste_v292_ajustes', 'teste_compat_v292', 'teste_impressao_escura', 'teste_painel_v292',
  'teste_arquivar_data', 'teste_cnpj', 'teste_brilho_obs', 'teste_cores_grupos',
  'teste_freio_servidor', 'teste_v292_correcoes',
...
const SUBIDA = [
  'teste_v292_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_v292_correcoes',    /* CEP após o blur, painel x fonte, visualizador   */
  'teste_compat_v292',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v292',       /* nenhum token do painel pode ter morrido      */
