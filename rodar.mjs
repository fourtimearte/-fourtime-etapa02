...
const SUITES = [
  ...
  'teste_v286_ajustes', 'teste_compat_v286', 'teste_impressao_escura', 'teste_painel_v286',
...
const SUBIDA = [
  'teste_v286_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_compat_v286',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v286',       /* nenhum token do painel pode ter morrido      */
