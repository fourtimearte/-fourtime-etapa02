...
const SUITES = [
  ...
  'teste_v299_ajustes', 'teste_compat_v299', 'teste_impressao_escura', 'teste_painel_v299',
  'teste_arquivar_data', 'teste_cnpj', 'teste_brilho_obs', 'teste_cores_grupos',
  'teste_freio_servidor', 'teste_v299_correcoes', 'teste_cabecalho_v299',
...
const SUBIDA = [
  'teste_v299_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_v299_correcoes',    /* CEP após o blur, painel x fonte, visualizador   */
  'teste_cabecalho_v299',    /* as 12 células do cabeçalho, uma a uma           */
  ...
  'teste_compat_v299',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v299',       /* nenhum token do painel pode ter morrido      */
