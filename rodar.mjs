...
const SUITES = [
  ...
  'teste_v302_ajustes', 'teste_compat_v302', 'teste_impressao_escura', 'teste_painel_v302',
  'teste_arquivar_data', 'teste_cnpj', 'teste_brilho_obs', 'teste_cores_grupos',
  'teste_freio_servidor', 'teste_v302_correcoes', 'teste_cabecalho_v302',
...
const SUBIDA = [
  'teste_v302_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_v302_correcoes',    /* CEP após o blur, painel x fonte, visualizador   */
  'teste_cabecalho_v302',    /* as 12 células do cabeçalho, uma a uma           */
  ...
  'teste_compat_v302',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v302',       /* nenhum token do painel pode ter morrido      */
