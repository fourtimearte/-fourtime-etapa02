...
const SUITES = [
  ...
  'teste_v289_ajustes', 'teste_compat_v289', 'teste_impressao_escura', 'teste_painel_v289',
...
const SUBIDA = [
  'teste_v289_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_compat_v289',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v289',       /* nenhum token do painel pode ter morrido      */
