...
const SUITES = [
  ...
  'teste_v297_ajustes', 'teste_compat_v297', 'teste_impressao_escura', 'teste_painel_v297',
  'teste_arquivar_data', 'teste_cnpj', 'teste_brilho_obs', 'teste_cores_grupos',
  'teste_freio_servidor', 'teste_v297_correcoes', 'teste_cabecalho_v297',
...
const SUBIDA = [
  'teste_v297_ajustes',      /* o que a versão trouxe                        */
  ...
  'teste_v297_correcoes',    /* CEP após o blur, painel x fonte, visualizador   */
  'teste_cabecalho_v297',    /* as 12 células do cabeçalho, uma a uma           */
  ...
  'teste_compat_v297',       /* aqui a versão anterior entra como origem     */
  'teste_painel_v297',       /* nenhum token do painel pode ter morrido      */
