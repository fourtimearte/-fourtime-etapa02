...
const NOVA = process.env.FT_ARQ || 'fourtime-editor-v280.html';
const VER  = process.env.FT_VER || '3.280';
for (const antiga of ['fourtime-editor-v279.html','fourtime-editor-v278.html','fourtime-editor-v277.html','fourtime-editor-v276.html','fourtime-editor-v275.html','fourtime-editor-v274.html']){
