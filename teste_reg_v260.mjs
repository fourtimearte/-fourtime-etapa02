...
checa('versão publicada', await page.evaluate(() => FT_EDITOR), "3.272");
...
// v3.262: entraram razao, entrega e a lista enderecos
    checa('os campos do cadastro (16 + enderecos)', r6.camposCompletos, 17);
