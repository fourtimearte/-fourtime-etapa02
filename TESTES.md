...
| `teste_v284_ajustes` | módulo de layout, tabela, rodapé, cabeçalho das páginas 2+, compressão e caso extremo |
| `teste_compat_v284` | salva um `.ft` nas versões v274…v283 e abre na v284: cabeçalho, layouts, ajustes e totais campo a campo |
...
| `teste_painel_v284` | todo token do painel dev ainda chega ao documento |
