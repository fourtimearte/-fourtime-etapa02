...
| `teste_v278_ajustes` | módulo de layout, tabela, rodapé, cabeçalho das páginas 2+, compressão e caso extremo |
| `teste_compat_v278` | salva um `.ft` na v274/v275/v276 e abre na v277: cabeçalho, layouts, ajustes e totais campo a campo |
