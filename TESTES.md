...
| `teste_v287_ajustes` | módulo de layout, tabela, rodapé, cabeçalho das páginas 2+, compressão e caso extremo |
| `teste_compat_v287` | salva um `.ft` nas versões v274…v286 e abre na v287: cabeçalho, layouts, ajustes e totais campo a campo |
...
| `teste_painel_v287` | todo token do painel dev ainda chega ao documento |
