...
| `teste_v286_ajustes` | módulo de layout, tabela, rodapé, cabeçalho das páginas 2+, compressão e caso extremo |
| `teste_compat_v286` | salva um `.ft` nas versões v274…v285 e abre na v286: cabeçalho, layouts, ajustes e totais campo a campo |
...
| `teste_painel_v286` | todo token do painel dev ainda chega ao documento |
